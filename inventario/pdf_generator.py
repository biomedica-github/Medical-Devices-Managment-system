...
def generarOrdenServicio(orden_de_servicio):
    ...
    with pdf.table(
        ...
        row.cell("DATOS DEL EQUIPO", colspan=4, align='C',)
    ...
    with pdf.table(
        ...
        row.cell("DESCRIPCION DE LA FALLA", colspan=4, align='C',)
    ...
    pdf.output(name="media/Ordenes_servicio/"+f"OrdenServicio_{id}_{equipo_medico}.pdf")
